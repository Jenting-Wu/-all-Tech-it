    ...
    <div class="web_part">
        ...
        <div class="mainpart">
            ...
            <div class="l_part col-2">
                ...
                $sql = "SELECT * 
                            FROM `brands`
                            WHERE `brand_name` IN ('Apple', 'Amazon', 'Google', 'Samsung', '小米', '中華電信', '遠傳')";
                $stmt = $pdo->query($sql);
                            ...
                            <ul class="nav nav-tabs card-header-tabs">
                                ...
                                ?>
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <a class="nav-link <?= ${'strClass' . $obj['cate_id']} ?>" href="product_list_01_smart.php?cate_id=<?= $obj['cate_id'] ?>"><?= $obj['cate_name'] ?></a>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="firstline">
                                                ...
                                                <button class="compare" data-prod-id="<?= $obj['prod_id'] ?>" alt="">
                                                    <img src="img/icon_compare-list.svg" alt="">加入比較</button>
...
<div class="wrap d-sm-block d-md-none">
    ...
    <div class="moblie_part">
        ...
        <div class="lgbtn">
            <div class="btn-group btn-group-lg col-12" style="padding: 0;">
                <a href="./product_list_01_smart.php?cate_id=10&sub_cate_id=21" class="col-6 btn btn-light display_1 active" aria-current="page">智慧家電</a>
...
<!-- <script src="JS/compare_custom.js"></script> -->